...
$SERVER_IP = "minetality.com"; //Insert the IP of the server you want to query.
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <td><b>Status</b></td>
                    <td><?php if (empty($ping['error'])) {
                            echo "<i class=\"fa fa-check-circle\"></i> Server is online";
                        } else {
                            echo "<i class=\"fa fa-times-circle\"></i> Server is offline";
                        } ?></td>
                </tr>
                <?php if (empty($ping['error'])) { ?>
                ...
                if ($playerlist != "null") { //is at least one player online? Then display it!
                    ...
                    foreach ($playerlist as $player) {
                        ...
                        if ($shown < $show_max + 1 || $show_max == "unlimited") {
                            ?>
                            <a data-placement="top" rel="tooltip" style="display: inline-block;"
                               title="<?php echo $player; ?>">
                                <img src="<?php echo $url . $player; ?>/50" size="40" width="40" height="40"
                                     style="width: 40px; height: 40px; margin-bottom: 5px; margin-right: 5px; border-radius: 3px; "/></a>
                        <?php }
                    }
